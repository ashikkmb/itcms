...
export function Modal({ children, onClose, width = 520 }) {
  return (
    <div className="fade-in" style={{ position: "fixed", inset: 0, background: "#00000055", zIndex: 60, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }} onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="fade-up" style={{ background: "white", borderRadius: 14, width: "100%", maxWidth: width, padding: "32px 36px", boxShadow: "0 20px 60px #0005", position: "relative", maxHeight: "90vh", overflowY: "auto" }}>
        {children}
      </div>
    </div>
  );
